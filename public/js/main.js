...
{
	var new_seed = "pause today wool knife history because comic witness object sunset black patch"; //lightwallet.keystore.generateRandomSeed();
		...
		password: password,
	  	...
	  	ks.keyFromPassword(password, function (err, pwDerivedKey) {
	    	...
	    	else
	    	{
	    		...
	    		var web3 = new Web3(new Web3.providers.HttpProvider("http://episerver.dimension.it:8545"));
	  	...
	  	ks.keyFromPassword(password, function (err, pwDerivedKey) {
	    	...
	    	else
	    	{
			    ...
			    var provider = new HookedWeb3Provider({
  					host: "http://episerver.dimension.it:8545",
